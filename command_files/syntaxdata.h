...
public:
    ...
    static const QList<QPair<QString, QString>> systemAttributes() {
        static const QList<QPair<QString, QString>> list = {
            ...
            {"IsNetworkLicense", "1 if this is an instantiated network license, 0 otherwise"},
            {"Date", "Job date"},
            {"Time", "Job time"},
    ...
    static const QList<QPair<QString, QString>> options() {
        static const QList<QPair<QString, QString>> list = {
            ...
            {"ECLogLine", "Show log line about embedded code initialization and execution or not"},
...
//            {"execute", "Execute a program"},  // separate subset SyntaxKind::Execute; see keyExecute
            ...
            {"gdxLoad", "Load data from GDX at execution time respects options replace and filtered"},
...
//          {"solve", ""},       // separate subset SyntaxKind::Solve; see keySolve
            ...
            {"ReadyCollect", "Waits until a model solution is ready to be collected"},
            {"rel_eq", "relation eq ="},
            {"rel_ge", "relation ge >="},
            {"rel_gt", "relation gt >"},
            {"rel_le", "relation le <="},
